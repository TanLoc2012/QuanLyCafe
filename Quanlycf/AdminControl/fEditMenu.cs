...
namespace Quanlycf
{
    public partial class fEditMenu : Form
    {
	  ...
	  private void fEditMenu_Load(object sender, EventArgs e)
        ...
        private void notifyID_Click(object sender, EventArgs e)
        {
        ...
        private void changeThumbnail_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void changeDiscount_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void changeDescription_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void changePrice_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void changeTitle_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void inputTitleMenu_TextChanged(object sender, EventArgs e)
        {
