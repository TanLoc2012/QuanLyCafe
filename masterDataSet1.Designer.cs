...
namespace Quanlycf.masterDataSet1TableAdapters {
...
SELECT id, role_id, deleted, passwordNV, fullname, sex, dob, addressU, phone FROM tblUser WHERE (id = @id)";
        ...
        public virtual int Fill(masterDataSet1.tblUserDataTable dataTable) {
        ...
        public virtual masterDataSet1.tblUserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet1.tblUserDataTable dataTable = new masterDataSet1.tblUserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet1.tblUserDataTable dataTable) {
